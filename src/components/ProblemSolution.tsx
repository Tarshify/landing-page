            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-4xl mx-auto mb-20">
                    <div className="max-w-3xl mx-auto text-center mb-12">
                        <div>
                            ...
                            <p className="text-lg mb-8 text-foreground">
                                Beaucoup veulent lancer leur boutique en ligne…
                                Mais finissent enfermés dans des plateformes qui
                                ne leur appartiennent pas. Abonnements mensuels,
                                bugs, limitations. Au final la liberté promise
                                disparaît vite.
                            </p>
                        </div>
                    </div>
                    ...
                    <p className="text-base sm:text-lg  mt-8 mx-6 italic text-foreground">
                        La promesse de liberté se transforme vite en prison
                        digitale. Ce n'est pas toi qui possèdes ta boutique…
                            ...
                            <div className="flex flex-col gap-4 text-center">
                                ...
                                <div>
                                    <CardDescription className="text-base sm:text-lg text-foreground">
                                        Notre mission : développer des
                                        e-commerces sur mesure, autonomes et
                                        durables. Pour les marques et
                                        entrepreneurs qui veulent posséder leur
                                        boutique, pas la louer.
                                    </CardDescription>
                                </div>
                            </div>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            <div className="bg-background/50 rounded-lg py-6 px-4 sm:p-6 border border-border text-center">
                                <h3 className="text-xl font-semibold mb-3 gap-2 text-foreground">
                                    Et si ton e-commerce existe déjà sur un SaaS
                                    ou une solution WordPress ?
                                </h3>
                                ...
                                <p className="text-base sm:text-lg text-foreground ml-8">
                                    Migration, optimisation et autonomie totale.
                                    Le tout sans abonnement, sans dépendance,
                                    sans limites.
                                </p>
                            </div>
                            ...
                            <div className="text-center pt-4">
                                <p className="text-xl sm:text-2xl font-bold text-primary">
                                    Chez Tarshify, ton business t'appartient.
                                    Ton code aussi.
                                </p>
                            </div>
                        </CardContent>
