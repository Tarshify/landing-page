            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto text-center mb-12">
                    ...
                    <h2 className="text-4xl sm:text-5xl font-bold mb-6 bg-gradient-to-r from-[#F7F3ED] to-[#F0D1BF] bg-clip-text text-transparent">
                        Ce qu&apos;on{" "}
                        <span className="text-primary">t&apos;apporte</span>{" "}
                        concrètement
                    </h2>
                    <p className="text-lg sm:text-xl text-foreground">
                        Notre mission est de développer des e-commerces qui
                        durent, qui performent et qui t&apos;appartiennent. On
                        pose une base technique et stratégique complète. Tout ce
                        qu&apos;il faut pour faire grandir ton business sans
                        dépendance.
                    </p>
                </div>
                ...
                <div className="max-w-3xl mx-auto text-center">
                    <p className="text-lg sm:text-xl text-foreground mb-4">
                        On ne livre pas juste un site. On construit un
                        e-commerce qui t&apos;appartient, que tu comprends et
                        que tu maîtrises.
                    </p>

                    <p className="text-base sm:text-lg text-primary mt-8 mb-6 mx-6 italic">
                        Parce qu&apos;un bon e-commerce, c'est toi qui le
                        contrôles, pas l&apos;inverse.
                    </p>
                    <a
