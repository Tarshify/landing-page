            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl sm:text-2xl  mb-12 max-w-2xl mx-auto text-foreground ">
                        Marre des abonnements et des contraintes ? Chez
                        Tarshify, on développe des e-commerces performants,
                        autonomes et 100 % à toi. Pas de licence, pas de
                        dépendance. Juste une boutique rapide, rentable et
                        libre.
                    </p>
